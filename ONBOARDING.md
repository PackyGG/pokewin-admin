...
- **Risky signup locations:** verified Fraud users can manage enabled ISO country rules with a reason, expiry, bounded risk weight, and 1–60 minute monitor duration in the Antifraud database. Location alone remains evidence/review context and cannot automatically ban, lock, or require KYC. A match retains the location signal and may extend an otherwise eligible monitor window.
