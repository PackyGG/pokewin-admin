...
/**
 * What a support agent sees: every published quiz their role can take, what it
 * pays, how many attempts they have left, and their best result so far.
 * Authoring lives on the separate owner/admin management surface.
 *
...
export async function StaffQuizzes() {
