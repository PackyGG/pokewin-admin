...
export default function VouchersError({
  ...
  useEffect(() => {
    reportWebappError({
      ...
      boundary: "(admin)/vouchers",
      error,
      digest: error.digest,
    });
    console.error("[vouchers] page error boundary caught:", error);
  }, [error]);
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              The vouchers query failed while rendering. The error was
              logged — no voucher was issued, redeemed, or revoked as a
