 ...
 */
export default function UpgraderError({
  error,
  reset,
}: {
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h1 className="text-xl font-semibold leading-tight tracking-tight">
              Couldn&apos;t load the upgrader
            </h1>
            <p className="mt-1 text-sm text-muted-foreground">
              An upgrader aggregate failed while rendering. The error was
              logged — the underlying ledger data is intact, just temporarily
