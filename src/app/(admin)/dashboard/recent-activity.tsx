...
// Full-width single feed replaces the old paginated table + split
// LiveDeposits/LiveActivity panels. Polls every 3s, pauses while the tab
// is hidden, caps rendered rows so the page stays fast on long-running
// sessions.
const MAX_ITEMS = 50;
...
// Friendly labels for raw ledger types — "Battle wager" instead of
// `battle_bet`.
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-card via-card to-card/80">
      ...
      <div className="relative flex flex-col p-5 sm:p-6">
        ...
        <div className="max-h-[40rem] overflow-y-auto -mx-5 px-5 sm:-mx-6 sm:px-6">
          {items.length === 0 ? (
