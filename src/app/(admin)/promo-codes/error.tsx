...
/**
 * Route-level error boundary for the /promo-codes tree (list +
 * /promo-codes/[id]).
 *
...
export default function PromoCodesError({
  ...
  useEffect(() => {
    reportWebappError({
      ...
      boundary: "(admin)/promo-codes",
      error,
      digest: error.digest,
    });
    console.error("[promo-codes] page error boundary caught:", error);
  }, [error]);
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              The promo-codes query failed while rendering. The error was
              logged — no promo code was created, redeemed, or revoked as a
