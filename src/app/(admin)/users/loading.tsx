...
/**
 * Matches /users: hero, 2-tile KPI strip (Total Users · Signups 24h — the
 * banned count is a sub line inside Total Users, not its own tile), "All
 * Users" section heading, toolbar (search + role + status), users table,
 * pagination. Shapes mirror page.tsx 1:1 so the real content swaps in
 * without layout jump — the real strip renders exactly 2 tiles in a
 * `grid-cols-2`, so the skeleton must too.
 */
