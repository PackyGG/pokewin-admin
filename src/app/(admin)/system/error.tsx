...
/**
 * Route-level error boundary for the /system tree (commands,
...
export default function SystemError({
  ...
  useEffect(() => {
    reportWebappError({
      ...
      boundary: "(admin)/system",
      error,
      digest: error.digest,
    });
    console.error("[system] page error boundary caught:", error);
  }, [error]);
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              A system query failed while rendering. The error was logged —
              no system setting or exclusion was modified by this error.
              {error.digest && (
