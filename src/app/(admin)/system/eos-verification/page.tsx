 ...
 *
 * Latest completed battles, 5/page, each row collapsible — creator +
 * won/lost (house POV) shown right on the row. Expanding a row fetches
 * (on-demand, via a Server Action) a live resolve of the battle's stored
 * `eos_block_hash` (and the 4 blocks before it) against the public EOS RPC
 * providers — see actions.ts / lib/eos/verify.ts.
 *
