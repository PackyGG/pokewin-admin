...
// NOTE: this table intentionally has NO special-case editor for array-shaped
// geo/fiat policy keys. `locked_deposits_fiat` (and the other
// GEO_POLICY_SITE_CONFIG_KEYS) are filtered out of `config` upstream in
// security-sections-loader.tsx — that surface lives on /fiat and
// /system/geo-blocking, where edits update the per-location rows atomically.
