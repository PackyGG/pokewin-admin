...
/**
 * Route-level error boundary for /sets.
 *
...
export default function SetsError({
  ...
  useEffect(() => {
    console.error("[sets] page error boundary caught:", error);
  }, [error]);
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              The sets query failed while rendering. The error was logged —
              no set definition was modified by this error.
              {error.digest && (
