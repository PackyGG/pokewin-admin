...
const volumeConfig = {
  wagerVolume: { label: "Wager Volume", color: "var(--color-chart-1)" },
  depositVolume: { label: "Deposit Volume", color: "var(--color-chart-2)" },
  commission: { label: "Commission", color: "var(--color-chart-3)" },
} satisfies ChartConfig;

const activityConfig = {
  signups: { label: "Signups", color: "var(--color-chart-4)" },
