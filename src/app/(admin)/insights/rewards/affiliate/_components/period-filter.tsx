...
/**
 * Period chips for /insights/rewards/affiliate. Same 6-window grain
 * the parent /insights/rewards page exposes (24h / 3d / 7d / 30d /
 * 90d / lifetime). Preserves `?tab=` so flipping the period stays on
 * the active tab.
 */
const PERIODS = [
  { label: "24h", value: "24h" },
