...
import { AffiliateInsightsTabSkeleton } from "./_components/tab-skeleton";

/**
 * Route-level loading skeleton for /insights/rewards/affiliate — keeps the
 ...
 * the 11-tab switch) over the default Overview body — reusing the page's
 * own `AffiliateInsightsTabSkeleton` (KPI strip + chart + table) so the
 * body matches the real tab content 1:1 and nothing jumps.
 */
export default function AffiliateInsightsLoading() {
  return (
    <div className="space-y-6">
      <PageHeroSkeleton action />
      <TabBarSkeleton count={11} />
