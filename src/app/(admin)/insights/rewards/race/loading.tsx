...
import { RaceInsightsTabSkeleton } from "./_components/tab-skeleton";

/**
 * Route-level loading skeleton for /insights/rewards/race — keeps the
 ...
 * the 10-tab switch) over the default Overview body — reusing the page's
 * own `RaceInsightsTabSkeleton` (KPI strip + chart + two panels) so the
 * body matches the real tab content 1:1 and nothing jumps.
 */
export default function RaceInsightsLoading() {
  return (
