...
const STATUS_CLASSES: Record<string, string> = {
  ...
  approval_processing: "border-blue-500/30 bg-blue-500/15 text-blue-600 dark:text-blue-400",
  refund_pending: "border-violet-500/30 bg-violet-500/15 text-violet-600 dark:text-violet-400",
  refund_failed: "border-red-500/30 bg-red-500/15 text-red-600 dark:text-red-400",
