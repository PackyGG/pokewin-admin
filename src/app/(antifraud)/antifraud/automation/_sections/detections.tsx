...
import { AUTOMATION_FLOWS, type AutomationFlow } from "../automation-catalog";
import { EmptyState, ModeBadge, StatusBadge } from "./shared";

/**
 * DETECTIONS TAB — everything that can fire, split by who owns it.
 *
 ...
 */
export async function AutomationDetections() {
