...
import { acknowledgeCreatorRewardClaimJob } from "@/lib/discord-creator-reward-claims";
...
export const POST = withApiKey<{ id: string }>(
  ...
  async (request, context) => {
    ...
    try {
      return await acknowledgeCreatorRewardClaimJob({
        id: params.data.id,
      ...
      if (
        ...
        error.message === "Creator reward claim lease not found."
      ) {
