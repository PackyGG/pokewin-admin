...
import { acknowledgeCreatorDepositJob } from "@/lib/discord-creator-deposits";
...
export const POST = withApiKey<{ id: string }>(
  ...
  async (request, context) => {
    ...
    try {
      return await acknowledgeCreatorDepositJob({
        id: params.data.id,
      ...
      if (
        ...
        && error.message === "Creator deposit lease not found."
      ) {
