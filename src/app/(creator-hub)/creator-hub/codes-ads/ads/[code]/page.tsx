...
import { HUB_CODES_ADS_ADS_TAB } from "../../_lib/tab";

export const metadata = { title: "Ad Code · Creator Hub" };

export default async function HubAdCodeDetailPage({
  params,
}: {
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-muted-foreground">
        ...
        on this code to. Sorted by attributed wager DESC. Includes users who
        never appeared as a signup — e.g. someone who used the code on a deposit
        row.
      </p>
      <div className="rounded-2xl border overflow-hidden overflow-x-auto">
        <Table>
