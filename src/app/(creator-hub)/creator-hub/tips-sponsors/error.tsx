 ...
 * uncaught throw from the KPI strip or a spend query no longer
    ...
    <div className="space-y-5 motion-safe:animate-in motion-safe:fade-in motion-safe:duration-300">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h1 className="text-xl font-semibold leading-tight tracking-tight">
              Couldn&apos;t load Tips &amp; Sponsors
            </h1>
            <p className="mt-1 text-sm text-muted-foreground">
              A tips-and-sponsors query failed before the page could
              render. The error was logged — try again, or head back to
              the hub dashboard.
              {error.digest && (
      ...
      <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-4">
        <p className="text-xs text-muted-foreground">
          One of the spend queries (session spend, ledger window, the
          creator breakdown) threw or the backend API was unreachable. If
