...
export const DISCORD_COMMAND_CATALOG: readonly DiscordCommandCatalogEntry[] = Object.freeze([
  ...
  { name: "ranks", description: "Show all nine community ranks and requirements.", surfaces: ["main"], access: "everyone", restriction: "Everyone in the PackyGG server; no DMs." },
  { name: "lb", description: "Show the top-ten community XP leaderboard.", surfaces: ["main"], access: "everyone", restriction: "Everyone in the PackyGG server; no DMs." },
