...
const RAW_NAV_ENTRIES: NavEntry[] = [
  ...
  {
    id: "nav.finances.expenses",
    group: "Finances",
    label: "Expenses",
    href: "/finances/expenses",
    pageKey: "/finances/expenses",
    icon: "Receipt",
    usernameAllowlist: ["motha"],
    isNew: true,
    inSidebar: true,
  ...
  {
    id: "nav.finances.subscriptions",
    group: "Finances",
    label: "Subscriptions",
    href: "/finances/subscriptions",
    pageKey: "/finances/subscriptions",
    icon: "CalendarClock",
    usernameAllowlist: ["motha"],
    isNew: true,
    inSidebar: true,
  ...
  },
  {
    ...
    icon: "ShieldCheck",
    description: "PackyGG community XP, ranks, roles, and moderation",
