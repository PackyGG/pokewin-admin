...
const signupSchema = z.object({
  ...
  abstract_ip_status: z.string().nullable(),
  abstract_ip_score: z.number().nullable(),
  abstract_ip_signals: z.array(signalSchema),
  abstract_email_status: z.string().nullable(),
  abstract_email_score: z.number().nullable(),
  abstract_email_signals: z.array(signalSchema),
  opportify_status: z.string().nullable(),
  opportify_score: z.number().nullable(),
  opportify_signals: z.array(signalSchema),
