...
export const MONITOR_EVENT_CATALOG: MonitorEventDefinition[] = [
  ...
  event(
    ...
    "Money",
    "A deposit has neither a fiat-intent link nor crypto settlement evidence.",
    "Ledger",
  ),
  event(
    "paid_pack_opened",
  ...
  event(
    ...
    "Reward pack granted",
    "Rewards",
    "A pack or reward is granted to the player.",
    "User rewards",
  ),
  event(
    "reward_opened",
    "Reward pack opened",
    "Rewards",
    "The player opens a granted pack or reward.",
    "User rewards",
  ),
  event(
    "bonus_received",
    "Bonus received",
    "Rewards",
    "A deposit bonus, promo, gift card, balance reward, or waitlist prize is credited.",
    "Ledger",
  ),
  ...
  event("ledger_creator_tip", "Creator tip sent", "Social", "The player sends a creator tip.", "Ledger"),
  event(
  ...
  event(
    "signup_reward_claimed",
    "Signup reward claimed",
    "Rewards",
    "The player explicitly claims a signup reward before it is granted or opened.",
    "Planned source",
    "planned",
  ),
  event(
    ...
    "Daily pack claimed",
    "Rewards",
    "The player claims a daily pack.",
    "Planned source",
    "planned",
  ),
  ...
  event("rain_won", "Rain won", "Rewards", "The player receives a completed rain payout.", "Planned source", "planned"),
