...
| `codes-ads` dedicated hub route | **DONE** (`9f0c02f8`) | `/creator-hub/codes-ads` — lazy tabs |
| Hub ad detail route | **DONE** (`73282fc9`) | `/creator-hub/codes-ads/ads/[code]` — cards link here; prod minted verify **PARTIAL** (SESSION_SECRET gap) |
