...
test("canonical financial aggregates subtract only finalized fiat refunds", () => {
  const files = [
    ...
    "src/lib/queries/insights-analytics/real-numbers.ts",
    "src/lib/queries/insights-analytics/overview.ts",
    "src/lib/queries/insights-analytics/geo.ts",
    "src/lib/queries/map.ts",
    "src/lib/queries/insights-analytics/money-flow.ts",
    "src/lib/queries/insights-analytics/ltv.ts",
    "src/lib/queries/insights-analytics/cohorts.ts",
    "src/lib/queries/insights-analytics/sources.ts",
    "src/lib/queries/insights-analytics/whales.ts",
